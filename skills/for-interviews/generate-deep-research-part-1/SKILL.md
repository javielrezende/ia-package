---
name: generate-deep-research-part-1
description: |
  Conduz uma conversa curta e adaptativa, no máximo 6 perguntas, para levantar tema, motivação, foco, contexto de aplicação e profundidade desejada, e entrega um briefing estruturado que serve de instrução para executar a Deep Research depois. Não produz a pesquisa em si. Use quando: (1) Preparar o briefing de uma pesquisa técnica antes de rodar uma Deep Research, (2) Estruturar o que investigar sobre uma tecnologia ou tema de arquitetura. Depois de ter o resultado da pesquisa, use a parte 2 para formatá-lo. Keywords: "deep research", "briefing de pesquisa", "pesquisa técnica", "preparar pesquisa", "parte 1".
---
