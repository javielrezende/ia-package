---
name: generate-deep-research-part-2
description: |
  Reorganiza o conteúdo de uma pesquisa já disponível no contexto em um Deep Research Document de 16 seções em Markdown, sem resumir, condensar ou omitir nada do material original. Use quando: (1) Formatar o resultado bruto de uma Deep Research no documento padrão, (2) Reestruturar relatórios, PDFs ou notas de pesquisa técnica no esqueleto de 16 seções. Use a parte 1 antes, para gerar o briefing da pesquisa. Keywords: "deep research document", "formatar pesquisa", "documento de pesquisa", "16 seções", "estruturar pesquisa", "parte 2".
---
