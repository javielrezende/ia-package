...
| Ciclo de vida | Somente leitura após a geração. A regeneração é integral (re-execute o `spec-writer`). Relatórios vão para outros arquivos (`impl-report.md`, `eval-report.md`), nunca para este. |
